...
int getNoise() { //main
	...
	std::cout << "Det & Mean & RMS \\\\" << std::endl << "EE & "
			<< noiseEE->GetMean() << "&" << noiseEE->GetRMS() << "\\\\"
			<< aboveEE->GetMean() << std::endl << "FH & " << noiseFH->GetMean()
			<< "&" << noiseFH->GetRMS() << "\\\\" << aboveFH->GetMean()
			<< std::endl << "BH & " << noiseBH->GetMean() << "&"
			<< noiseBH->GetRMS() << "\\\\" << aboveBH->GetMean() << std::endl
			<< "All & " << noise->GetMean() << "&" << noise->GetRMS() << "\\\\"
			<< std::endl;
