...
int plotResiduals() {
	...
	std::string suffix[nP] = { "_simpleweight_xy", "_simpleweight",
			"_logweight_xy", "_logweight_all", "_logweight_7_22",
			"_logweight_linearFrontBack" };

	std::string label[nP] = { "simple weighting, matrix=(x+y)/2.",
			"simple weighting, x and y sep.", "log weighting, matrix=(x+y)/2.",
			"log weighting, x and y sep.", "log weighting, fit only l=7-22",
