...
public:
	...
	void setRecoInfo(const TLorentzVector & g1, const TLorentzVector & g2,
			const ROOT::Math::XYZPoint & posFF1,
			const ROOT::Math::XYZPoint & posFF2);

	void setTruthInfo(const TLorentzVector & g1, const TLorentzVector & g2,
			const ROOT::Math::XYZPoint & vtx1,
			const ROOT::Math::XYZPoint & vtx2);

	void initialiseHistograms(TFile *fout, const std::string folder);
